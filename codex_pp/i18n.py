...
""",
    ...
    "config_import_success": "✓ 配置已从 {file} 导入",
    "config_export_success": "✓ 配置已导出到 {file}",
    ...
    "section_config": "① 配置管理",
    "section_models": "② 多模型支持",
    "section_skills": "③ Skill 系统(ai-agent-skills 集成)",
    "section_memory": "④ 持久化记忆",
    "section_stats": "⑤ 用量统计",
...
""",
    ...
    "skill_installed_msg": "✓ Installed: {name}",
    ...
    "config_import_success": "✓ Config imported from {file}",
    "config_export_success": "✓ Config exported to {file}",
    ...
    "section_models": "② Multi-model support",
    "section_skills": "③ Skills system (ai-agent-skills integration)",
    "section_memory": "④ Persistent memory",
    "section_stats": "⑤ Usage statistics",
